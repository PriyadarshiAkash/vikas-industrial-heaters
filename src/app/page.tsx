...
const PRODUCTS = [
  { id: "IM-001", name: "Immersion Heater – SS304", category: "Immersion", wattage: 1500, voltage: 230, material: "SS304", price: 799, leadDays: 3, img: "/Images/Immersion Heater – SS304.png", desc: "Household/industrial hot water; BSP thread; moisture sealed." },
  { id: "IM-002", name: "Immersion Heater – Incoloy 800", category: "Immersion", wattage: 2000, voltage: 230, material: "Incoloy 800", price: 1299, leadDays: 4, img: "/Images/Immersion Heater – Incoloy 800.png", desc: "Corrosion resistant alloy; for hard water/chemicals." },
  { id: "TB-010", name: "Tubular Heater – Finned", category: "Tubular", wattage: 3000, voltage: 415, material: "SS304", price: 2899, leadDays: 6, img: "/Images/3. Tubular Heater – Finned.png", desc: "Air/duct heating; high surface area fins for efficiency." },
  { id: "TB-011", name: "Tubular Heater – U-Bend", category: "Tubular", wattage: 2500, voltage: 230, material: "SS316", price: 2699, leadDays: 5, img: "/Images/4. Tubular Heater – U-Bend.png", desc: "Oil/water; custom bend radius and cold sections." },
  { id: "BD-020", name: "Band Heater – Mica", category: "Band", wattage: 1000, voltage: 230, material: "Mica", price: 1499, leadDays: 3, img: "/Images/5. Band Heater – Mica.png", desc: "Plastic extrusion/injection machines; up to 300°C." },
  { id: "BD-021", name: "Band Heater – Ceramic", category: "Band", wattage: 2500, voltage: 230, material: "Ceramic", price: 3299, leadDays: 7, img: "/Images/6. Band Heater – Ceramic.png", desc: "High temp up to 650°C; energy efficient insulation." },
  { id: "CR-030", name: "Cartridge Heater – High Density", category: "Cartridge", wattage: 500, voltage: 230, material: "Incoloy 800", price: 899, leadDays: 4, img: "/Images/7. Cartridge Heater – High Density.png", desc: "Molds/dies; precision fit; uniform heat profile." },
  { id: "CR-031", name: "Cartridge Heater – SS321", category: "Cartridge", wattage: 750, voltage: 230, material: "SS321", price: 999, leadDays: 4, img: "/Images/8. Cartridge Heater – SS321.png", desc: "General purpose; swaged construction; long life." },
];
